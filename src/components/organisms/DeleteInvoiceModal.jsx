...
function DeleteInvoiceModal({ invoice, onConfirm, onCancel }) {
      ...
      >
        <div className="p-6">
          ...
          <p className="text-sm text-slate-700 mb-6">
            Are you sure you want to delete invoice <strong>{invoice.invoiceNumber || 'this invoice'}</strong>? 
            This will permanently remove all invoice information.
          </p>
